...
using WebDriverCalculatorPOM1.Pages;
...
namespace WebDriverCalculatorPOM1.Tests
{
    public class SumNumbersPageTests:BaseTest
    {
        ...
        [Test]
        public void Test_SumNumberPage_SumTwoPossitiveNumbers()
        {
        ...
        [Test]
        public void Test_SumNumberPage_MultiplyTwoPossitiveNumbers()
        {
            var actualResult = page.CalculateNumbers("5", "*", "15");
        ...
        public void Test_SumNumberPage_MultiplyTwoPossitiveNumbers(string firstValue, string operation,string secondValue, string result)
        {
